...
def main() -> None:
    ...
    with st.sidebar:
        ...
        with st.expander("Diagnóstico do perfil"):
            ...
            if st.button(
                ...
                st.session_state["user_profile"] = confirmar_referencia_visual(
                    st.session_state["user_profile"],
                    ...
                    first_impression=(
                        "Mary percebeu maturidade, presença forte e charme."
                    ),
                )
                st.rerun()
    ...
    if uploaded_file is not None:
        st.image(
            uploaded_file,
            caption="Fotografia pronta para o próximo envio",
        )
