...
def build_route_compass(route: str, current_beat: str) -> dict[str, Any]:
    return build_story_compass(route, current_beat)
...
# Mantido por compatibilidade com versões antigas. O módulo agora é somente
# fachada da estrutura narrativa localizada no domínio da história.
